...
```{r}
# 繪製兩組樣本的整體心流箱型圖
flow_f <- data[data$Experimental_Condition == "心流", "Flow_Total"]
basic_f <- data[data$Experimental_Condition == "原始", "Flow_Total"]
all_f <- list(flow_f = flow_f, basic_f = basic_f)
boxplot(all_f)
```
...
```{r}
# 繪製兩組樣本的清晰的目標箱型圖
flow_f <- data[data$Experimental_Condition == "心流", "Flow_Goal"]
basic_f <- data[data$Experimental_Condition == "原始", "Flow_Goal"]
all_f <- list(flow_f = flow_f, basic_f = basic_f)
boxplot(all_f)
```
...
```{r}
# 檢驗兩組樣本的行動與意識的融合是否為常態分布（NO/MARGINAL）
...
```{r}
# 繪製兩組樣本的控制感箱型圖
flow_f <- data[data$Experimental_Condition == "心流", "Flow_Control"]
basic_f <- data[data$Experimental_Condition == "原始", "Flow_Control"]
all_f <- list(flow_f = flow_f, basic_f = basic_f)
boxplot(all_f)
```
...
```{r}
# 繪製兩組樣本的自得其樂的體驗箱型圖
flow_f <- data[data$Experimental_Condition == "心流", "Flow_Autotelic"]
basic_f <- data[data$Experimental_Condition == "原始", "Flow_Autotelic"]
all_f <- list(flow_f = flow_f, basic_f = basic_f)
boxplot(all_f)
```
...
```{r}
# 針對心流組的資料，檢驗Minecraft遊玩經驗與心流體驗是否有相關性（大多偏負相關）
cor.test(flow$Minecraft_Experience, flow$Flow_Total, alternative = "two.sided", method = "spearman")
cor.test(flow$Minecraft_Experience, flow$Flow_Balance, alternative = "two.sided", method = "spearman")
cor.test(flow$Minecraft_Experience, flow$Flow_Goal, alternative = "two.sided", method = "spearman")
cor.test(flow$Minecraft_Experience, flow$Flow_Feedback, alternative = "two.sided", method = "spearman")
cor.test(flow$Minecraft_Experience, flow$Flow_Merge, alternative = "two.sided", method = "spearman")
cor.test(flow$Minecraft_Experience, flow$Flow_Concentration, alternative = "two.sided", method = "spearman")
cor.test(flow$Minecraft_Experience, flow$Flow_Control, alternative = "two.sided", method = "spearman")
cor.test(flow$Minecraft_Experience, flow$Flow_Loss, alternative = "two.sided", method = "spearman")
cor.test(flow$Minecraft_Experience, flow$Flow_Time, alternative = "two.sided", method = "spearman")
cor.test(flow$Minecraft_Experience, flow$Flow_Autotelic, alternative = "two.sided", method = "spearman")
```

```{r}
# 針對原始組的資料，檢驗Minecraft遊玩經驗與心流體驗是否有相關性（大多偏正相關）
cor.test(basic$Minecraft_Experience, basic$Flow_Total, alternative = "two.sided", method = "spearman")
cor.test(basic$Minecraft_Experience, basic$Flow_Balance, alternative = "two.sided", method = "spearman")
cor.test(basic$Minecraft_Experience, basic$Flow_Goal, alternative = "two.sided", method = "spearman")
cor.test(basic$Minecraft_Experience, basic$Flow_Feedback, alternative = "two.sided", method = "spearman")
cor.test(basic$Minecraft_Experience, basic$Flow_Merge, alternative = "two.sided", method = "spearman")
cor.test(basic$Minecraft_Experience, basic$Flow_Concentration, alternative = "two.sided", method = "spearman")
cor.test(basic$Minecraft_Experience, basic$Flow_Control, alternative = "two.sided", method = "spearman")
cor.test(basic$Minecraft_Experience, basic$Flow_Loss, alternative = "two.sided", method = "spearman")
cor.test(basic$Minecraft_Experience, basic$Flow_Time, alternative = "two.sided", method = "spearman")
cor.test(basic$Minecraft_Experience, basic$Flow_Autotelic, alternative = "two.sided", method = "spearman")
```
...
flow_fpre <- data[data$Experimental_Condition == "心流", "AUT_Fluency_Pretest"]
flow_fpost <- data[data$Experimental_Condition == "心流", "AUT_Fluency_Posttest"]
all_fluency <- list(flow_fpre = flow_fpre, flow_fpost = flow_fpost)
boxplot(all_fluency, main = "Fluency (Flow-Promoting Minecraft)", names = c("Pretest", "Posttest"), col = colors)

boxplot(list(basic$AUT_Fluency_Pretest, basic$AUT_Fluency_Posttest))
```
...
boxplot(list(flow$AUT_Originality_Pretest, flow$AUT_Originality_Posttest))
boxplot(list(basic$AUT_Originality_Pretest, basic$AUT_Originality_Posttest))
```
...
boxplot(list(flow$RAT_Pretest, flow$RAT_Posttest))
boxplot(list(basic$RAT_Pretest, basic$RAT_Posttest))
```
