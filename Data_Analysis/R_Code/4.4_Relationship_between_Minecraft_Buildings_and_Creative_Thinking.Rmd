...
```{r}
# 針對心流組的資料，檢驗Minecraft建築的各項創意指標間是否有相關性
library(psych)
print(corTest(data[data$Experimental_Condition == "心流", 35:40], method = "spearman")$stars, quote = FALSE)
result <- corTest(data[data$Experimental_Condition == "心流", 35:40], method = "spearman")
```

```{r}
# 針對原始組的資料，檢驗Minecraft建築的各項創意指標間是否有相關性
print(corTest(data[data$Experimental_Condition == "原始", 35:40], method = "spearman")$stars, quote = FALSE)
result <- corTest(data[data$Experimental_Condition == "原始", 35:40], method = "spearman")
```

### **Divergent Thinking**

```{r}
# 針對心流組的資料，檢驗實驗前的發散思維流暢性與Minecraft建築創意是否有相關性（NO）
...
```{r}
# 針對原始組的資料，檢驗實驗前的發散思維流暢性與Minecraft建築創意是否有相關性（NO）
...
```{r}
# 針對心流組的資料，檢驗實驗前的發散思維獨創性與Minecraft建築創意是否有相關性（NO）
...
```{r}
# 針對原始組的資料，檢驗實驗前的發散思維獨創性與Minecraft建築創意是否有相關性（除了美感之外的每一項）
...
```{r}
# 針對心流組的資料，檢驗實驗前的收斂思維能力與Minecraft建築創意是否有相關性（NO）
...
```{r}
# 針對原始組的資料，檢驗實驗前的收斂思維能力與Minecraft建築創意是否有相關性（NO）
