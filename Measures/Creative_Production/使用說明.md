...
- **施測時長：** 約 60 分鐘。
- **補充事項：** 此文件主要說明 Minecraft 創意建築成品的評分細節，建造任務的內容請參閱 [XXX.pdf](XXX.pdf)。

## 工具說明

本研究通過專注於 Minecraft 社群中常用的評分指標，減少了評分負擔，這些指標也被用於其他遊戲中的創意產品評估，包含適當性、獨創性、美感、驚喜度、精細度和整體創造力（考量所有子面向）。
