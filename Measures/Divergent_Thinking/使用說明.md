...
在本研究中，AUT 的評分基於客觀的流暢性（回答數量）和主觀的獨創性（回答品質），這種方法已被證實可避免回答數量與品質之間的高度相關。測驗指導語也明確提及這些評分維度，以提高測驗結果的品質。具體而言，流暢性指的是受測者針對三個物品所提出的平均用途數量。獨創性則由包括作者在內的三位研究人員依照過往程序進行評分：

1. 將所有回答匿名化並修正拼寫錯誤。
2. 將每個物品的所有回答隨機排序後，讓評分者進行初步瀏覽，了解整體的創意程度。
