...
AUT 要求參與者為各種日常用品想出盡可能多的創意用途，每個物品的作答時間為 2 分鐘。本研究從 Patterson 等人蒐集的測驗數據中，分別選擇了三個物品作為前測題目（塑膠袋、吹風機、硬幣）和後測題目（衛生紙、衣架、牙膏），並以隨機順序呈現以避免順序效應。此外，預測前會提供一個練習項目（筷子）以讓參與者熟悉回應形式。
